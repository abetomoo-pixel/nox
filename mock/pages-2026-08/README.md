...
- **14枚目 `nox-cast-compensation-all-in-one.html`（2026-08-20 追加受領・sha256 `899e51000b21f705…6999f455`・39,474 bytes）＝「M2待遇」canonical**（待遇オールインワン・money-core 級）。**DP のトークン多数決は 13枚のまま**（DP0-1 裁定＝母数外）で、**DP の変換対象外**（DP1-④＝M2待遇レーン所属）。DP2 T4 で照合リストへ追記し git 追跡へ収蔵した（下表は 2026-08-08 受領時の 13枚のまま＝来歴クローズ済みの記録として保存）。
