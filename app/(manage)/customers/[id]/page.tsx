...
// 顧客詳細（F3b-A 塊2-2）。集計=customer_summary・履歴=customer_visit_history（mig0028）・
// 実体属性=customers 直 SELECT（RLS）・編集=customer_update。可視は RPC/RLS が物理保証＝
// ここの redirect は利便（一覧と同型・staff は can_crm のみ）。
