...
const TEMPLATES: Array<{ key: string; label: string; title: string; body: string }> = [
  ...
  // ★裁定168（v2.1 N32・夜間 O2）: モックの5種へ（仮シフト公開／シフト確定を追加・ラベルはモック逐語）。
  //   定数のみ＝DB・RPC 不変。本文はマイページの既存導線（希望／シフト確認）だけを案内する。
  {
    key: "shift_proposed", label: "仮シフト公開",
    title: "仮シフトを公開しました",
    body: "来期の仮シフトを公開しました。\nマイページの「シフト」からご自身の予定を確認し、問題なければ確認ボタンを押してください。\n変更の希望がある場合は店長までご連絡ください。",
  },
  {
    key: "shift_confirmed", label: "シフト確定",
    title: "シフトが確定しました",
    body: "対象期間のシフトが確定しました。\nマイページの「シフト」から確定内容をご確認ください。\n確定後の変更は個別にご相談ください。",
  },
  {
    key: "meeting", label: "全体ミーティング",
    title: "全体ミーティングのご案内",
    body: "全体ミーティングを行います。\n日時：\n場所：\n議題：\n出勤前の時間に実施しますので、遅れないようお願いします。",
  },
  {
    key: "payroll", label: "給与明細公開",
    title: "給与明細を公開しました",
