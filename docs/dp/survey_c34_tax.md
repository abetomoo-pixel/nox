...
> ★同日 §6-3（mig0112）で billing も **51→52**（A8 名簿+1 の runtime 代表＝裁定90 予告どおり）。
> 以後の golden 6値 = **5931/125802/55233/57/64/52**。
> ★同日 §6-4（mig0113 挙動段）で receipt 57→**64**（外税/exempt/鏡像）。
> 以後の golden 6値 = **5931/125802/55233/64/64/52**（receipt と rate-back が同数になったのは偶然）。
