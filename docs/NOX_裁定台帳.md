...
## 裁定268（Agoora 承認 2026-09-17）/shift 今日タブの行に遅刻分数「(+N 分)」を出す（client のみ・未着手）
...
適用＝未着手（client 1 レーン）。前提の読取＝shift-board.tsx 764〜778（punches 読取・punchIn）・806〜828（todayCounts＝matchPunches）・1072〜1076（「HH:MM打刻」の補助表示・裁定222）。
