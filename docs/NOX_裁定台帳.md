...
収蔵 `ec6c3e3`（2026-09-25 便 F2「mig: 0154 出退勤・報酬型(手貼り済み・裁定294/295)」・client 11 本と 1 本で push＝便 F4）。v39 §5-3＝suite の net 期待値の変動（pay T1a 1,117,059→1,133,559／T1b 1,192,348→1,208,848／payroll-adjust pa(0-6d) 152,326→155,326／payroll F2f 複合 700,385→724,385）は**裁定293-3（罰金撤去）の帰結として承認・golden 3 値（5931／125802／55233）不変**（2026-09-25 便 F3）。suite 追従＝AG d 38 段を punch-match (9)／cast-guarantee (10)(11)／payroll-adjust (8)／payroll 段0154／store-profile sp(⑤-10) へ移植（夜間便 2 N4）。
