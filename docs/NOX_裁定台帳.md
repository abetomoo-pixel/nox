...
コミット 4 本＝`478303d`（client 前倒し）／`fe0e19c`（v37 収蔵）／`8af0be5`（0148 SQL 収蔵＋名簿／probe／pin＋suite 5 本＋三面鏡）／`d7a2084`（reopen pin）＝f0 2 連緑（58 段 4,337・613s／851s）で push（`580718a..d7a2084`・2026-09-18 12:18 JST）。教訓88（DB を触る node -e は finally で閉じる）は本便の全 script で遵守（提案のまま・収載は Agoora 判断）。
