...
★0154 の git add は未収蔵（明朝の F 便で client 9 本と一緒に push）。suite 追従＝AG d 38 段を punch-match (9)／cast-guarantee (10)(11)／payroll-adjust (8)／payroll 段0154／store-profile sp(⑤-10) へ移植（夜間便 2 N4）。
