...
適用＝未着手。裁定125（ローンチ範囲）の追補として本エントリを参照。モックの出典＝mock/onboarding-2026-08/（step1〜5・業態別 step1／step2 各 5）。
